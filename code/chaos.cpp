...
int main()
{
	...
	sf::Text text;
	text.setFont(font);
	text.setString("Pick a number 1-3 from keyboard --  only once i didnt fully fix it lol || 1 = 3 pts|| 2 = 4pts || 3 = 5pts|| \n After Selecting vertices count click on the screen \n Press Escape to Quit \n pressing enter to reset is kinda iffy");
